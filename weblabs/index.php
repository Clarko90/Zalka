    ...
    <main>
        <div class="container px-4 py-5" id="custom-cards">
            ...
            <div class="alert alert-danger" role="alert">
                ...
                <p>If that doesn't work, well good luck.</p>
            </div>
            <?php } ?>
            ...
            <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
                ...
                <div class="col">
                    <div class="card card-cover h-100 overflow-hidden text-black bg-white rounded-5 shadow-lg"
                        id="card18" style="background-image: url('assets/logo-bg.png');background-repeat: no-repeat; background-position: center 30%">
                        <div class="d-flex flex-column h-100 p-5 pb-3 text-shadow-1">
        ...
        <div>
            <p class="small text-center">PQE 2024</p>
        </div>
        <!-- instructions modal -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Follow the PQE course, and choose one of the following labs. </p>
                        <p>Generally, the third lab in each section is a challenge. E.g. Injection 0x01 and 0x02 are
                            easier, whilst injection 0x03 is chance for you to test what you've learned.</p>
                        <p>To reset the lab databases, visit /init.php</p>
                        <p>If you have issues, just ask the consulant!</p>
                        <hr>
                        <p>Good luck!</p>
                    </div>
                </div>
